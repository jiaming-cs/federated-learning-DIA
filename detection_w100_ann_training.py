...
#     print(all_data_FT.x_data[0])
    ...
    for epoch in range(EPOCH):
        ...
        ann_f1_score.append(sklearn.metrics.f1_score(ann_final_test, ann_final_prediction, average='binary').item())
        ann_recall.append(sklearn.metrics.recall_score(ann_final_test, ann_final_prediction, average='binary').item())
        ann_precision.append(sklearn.metrics.precision_score(ann_final_test, ann_final_prediction, average='binary', zero_division='warn').item())
...
for i in range(KFOLD):
    ...
    plt.savefig('../fig/w100_detection/'+'Loss_Kfold_ANN_w100_detection_'+str(i+1)+'.png',dpi=500)
    ...
    plt.title('ROC curve')
    plt.savefig('../fig/w100_detection/'+'ROC_Kfold_ANN_w100_detection_'+str(i+1)+'.png',dpi=500)
    
    
pickle_out = open('Ann_w100_10fold_detection.pickle', 'wb')
