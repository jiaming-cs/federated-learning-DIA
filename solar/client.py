...
def load_data(client_num,fault_index):
    train_dataset = WaveformDetectionDLPickle(DATASET_DIR, client_num, fault_index)
    test_dataset = WaveformDetectionDLPickle(DATASET_DIR, -1, fault_index)
...
net = LSTM()
train_dataset, test_dataset = load_data(args.client_num, args.fault_index)
